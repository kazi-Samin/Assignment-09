    ...
    <ProtectedRoute>
      ...
      <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row w-full overflow-x-hidden">
        ...
        <div className="flex-1 flex flex-col w-full max-w-full overflow-x-hidden">
          ...
          {/* Header */}
          <header className="h-20 bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-10 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              {user && (
                ...
                <div className="flex items-center gap-3 bg-white border border-slate-200 rounded-full pl-2 pr-3 py-2 shadow-sm max-w-[220px]">

                  <div className="w-11 h-11 rounded-full bg-emerald-600 text-white font-bold flex items-center justify-center overflow-hidden shrink-0">
          ...
          {/* Mobile Nav */}
          <div className="lg:hidden bg-white border-b border-slate-200 px-3 py-3 flex gap-2 overflow-x-auto scrollbar-hide">
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className={`whitespace-nowrap px-4 py-2 rounded-full text-sm font-semibold shrink-0 ${
                    isActive
